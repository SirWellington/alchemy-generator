...
class BooleanGeneratorsJ {
    private final static Logger LOG = LoggerFactory.getLogger(BooleanGeneratorsJ.class);

    private BooleanGeneratorsJ() throws IllegalAccessException {
